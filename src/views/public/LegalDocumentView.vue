<template>
  <div class="public-dark-surface min-h-screen text-white">
    <header class="border-b border-dark-700/70 bg-dark-900/85 backdrop-blur-xl">
    ...
    <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:py-10">
      ...
      <article v-else class="card p-5 sm:p-7">
        ...
        <div
          v-else
          class="analytics-inset border-dashed px-6 py-14 text-center text-sm text-dark-400"
        >
          {{ t('legal.empty') }}
        </div>
      </article>
