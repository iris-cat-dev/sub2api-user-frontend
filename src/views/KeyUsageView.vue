<template>
  <div class="public-dark-surface relative flex min-h-screen flex-col">
        ...
        <div v-else-if="resultData" class="space-y-6">
          ...
          <div v-if="ringItems.length > 0" :class="ringGridClass">
            <div
              ...
              :key="i"
              class="card fade-up p-8 backdrop-blur-sm transition-all duration-300 hover:shadow-card-hover"
