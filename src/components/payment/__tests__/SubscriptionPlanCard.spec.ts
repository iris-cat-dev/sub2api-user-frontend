...
describe("SubscriptionPlanCard", () => {
  ...
  // The API accepts plural validity units; the user card must not fall back to days.
  it("renders plural validity units instead of mislabeled days (#4607)", () => {
  ...
  it("shows legacy USD plans as yuan while preserving configured non-USD currencies", () => {
    ...
    expect(mountPlanCard("openai", { currency: "USD" }).text()).toContain("¥10元");
