    ...
    >
      <thead>
        <tr class="border-b border-gray-100 bg-gray-50/50 text-xs font-medium uppercase tracking-wide text-gray-500 dark:border-dark-700 dark:bg-dark-800/50 dark:text-gray-400">
          <th class="w-[180px] px-4 py-3 text-center">{{ t('availableChannels.columns.name') }}</th>
          <th class="w-[200px] px-4 py-3 text-left">{{ t('availableChannels.columns.description') }}</th>
          <th class="w-[140px] px-4 py-3 text-left">{{ t('availableChannels.columns.platform') }}</th>
          <th class="px-4 py-3 text-left">{{ t('availableChannels.columns.groups') }}</th>
          <th class="px-4 py-3 text-left">{{ t('availableChannels.columns.supportedModels') }}</th>
        </tr>
      </thead>
      <tbody v-if="loading">
        <tr>
