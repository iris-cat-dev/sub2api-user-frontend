<template>
  <button
    type="button"
    class="card group flex min-h-[280px] w-full flex-col p-5 text-left transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-primary-500/30 hover:shadow-card-hover"
    @click="emit('click')"
  >
