...
type DisplayAnnouncement = Pick<UserAnnouncement, 'title' | 'content' | 'created_at'>

const { t } = useI18n()
const announcementStore = useAnnouncementStore()
const displayedAnnouncement = computed<DisplayAnnouncement | null>(() => announcementStore.currentPopup)
